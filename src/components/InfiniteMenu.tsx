...
// ... (skipping shaders and base classes for brevity in this replace call, but they should remain unchanged)
// Actually, I should probably replace the whole file or at least the imports and the class.

// Let me find the class and the imports.
